...
if __name__ == '__main__':
    ...
    parser.add_argument('--d_core', type=int, default=512, help='dimension of core in SOFTS')
    parser.add_argument('--seg_len', type=int, default=8, help='Corssformer')
    ...
    # TimeMixer
    parser.add_argument('--down_sampling_layers', type=int, default=3, help='TimeMixer')
    parser.add_argument('--down_sampling_window', type=int, default=2, help='TimeMixer')
    parser.add_argument('--down_sampling_method', type=str, default='avg', help='TimeMixer')
    parser.add_argument('--decomp_method', type=str, default='moving_avg', help='TimeMixer')
    parser.add_argument('--use_norm', type=int, default=1, help='whether to use normalize; True 1 False 0')
    parser.add_argument('--use_future_temporal_feature', type=int, default=0,
                        help='whether to use future_temporal_feature; True 1 False 0')

    # TimeSter
    parser.add_argument('--rda', type=int, default=1)
    ...
    # FreDN
    parser.add_argument('--embed_size', type=int, default=128, help='my model')
    parser.add_argument('--hidden_size', type=int, default=256, help='my model')
    parser.add_argument('--hidden_layers', type=int, default=2, help='number of hidden layers in projector')
