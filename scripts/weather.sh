...
declare -A param_map=(
    [96]="0.3 1 128 0.01 type1"
    [192]="0.2 3 64 0.01 type1"
    [336]="0.2 3 16 0.01 type1"
    [720]="0.2 1 16 0.01 type1"
)
...
for sl in "${s_list[@]}"; do
    for pl in "${pl_list[@]}"; do
        ...
        JOB_DIR=$OUTPUT_DIR/${model_name}_weather
        mkdir -p $JOB_DIR
