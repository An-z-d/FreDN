...
declare -A param_map=(
    [96]="0.3 3 128 0.001 type1"
    [192]="0.3 4 128 0.001 type1"
    [336]="0.3 4 64 0.001 type1"
    [720]="0.1 4 64 0.002 type1"
)
...
for sl in "${s_list[@]}"; do
    for pl in "${pl_list[@]}"; do
        ...
        JOB_DIR=$OUTPUT_DIR/${model_name}_ETTm1
        mkdir -p $JOB_DIR
