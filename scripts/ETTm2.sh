...
declare -A param_map=(
    [96]="0.2 3 128 0.002 type1"
    [192]="0.1 1 64 0.002 type1"
    [336]="0.3 2 32 0.002 type1"
    [720]="0.2 2 32 0.001 type1"
)
...
for sl in "${s_list[@]}"; do
    for pl in "${pl_list[@]}"; do
        ...
        JOB_DIR=$OUTPUT_DIR/${model_name}_ETTm2
        mkdir -p $JOB_DIR
